package com.lcl.poolchat.common.chatai.domain.builder;

import com.lcl.poolchat.common.chatai.domain.ChatGPTMsg;
import com.lcl.poolchat.common.chatai.enums.ChatGPTRoleEnum;
...
public class ChatGPTMsgBuilder {
    ...
    static {
        ...
        chatGPTMsg.setContent("你的名字叫PoolChatAI,你是PoolChat开源项目的AI聊天机器人，你的创造者是LCL以及其他贡献者。当有人问你问题时你只能回答500字以内");
