package com.lcl.poolchat.common.common.config;

import com.lcl.poolchat.common.common.factory.MyThreadFactory;
import com.lcl.poolchat.transaction.annotation.SecureInvokeConfigurer;
...
public class ThreadPoolConfig implements AsyncConfigurer, SecureInvokeConfigurer {
     ...
     * 项目共用线程池
     */
    public static final String POOLCHAT_EXECUTOR = "poolchatExecutor";
    /**
     * websocket通信线程池
     */
    ...
    @Bean(POOLCHAT_EXECUTOR)
    @Primary
    public ThreadPoolTaskExecutor poolchatExecutor() {
        ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
        executor.setCorePoolSize(10);
        executor.setMaxPoolSize(10);
        executor.setQueueCapacity(200);
        executor.setThreadNamePrefix("poolchat-executor-");
